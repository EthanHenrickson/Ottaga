    ...
    <div class="profile">
        ...
        <div class="section">
            ...
            <div class="checkbox setting">
                ...
                <input type="checkbox" name="" id="digest" bind:checked={userSettings.receiveCommunityDigest}>
            </div>
        </div>
        <div class="section">
            <h3>Accessibility</h3>
            <div class="checkbox setting">
                ...
                <input type="checkbox" name="" id="simplifiedLanguage" bind:checked={userSettings.simplifiedLanguage}>
            </div>
            <div class="checkbox setting">
                <label for="reducedMotion">Use Reduced Motion</label>
                <input type="checkbox" name="" id="reducedMotion" bind:checked={userSettings.reduceMotion}>
            </div>
        </div>
        <div class="section">
            <h3>Privacy</h3>
            <div class="checkbox setting">
                ...
                <input type="checkbox" name="" id="saveConversations" bind:checked={userSettings.saveConversations}>
            </div>
        </div>
